...
import { mainNav, dropdownNav, dropdownChildNav, childDropdownNav } from '../../../constants/header';
			    ...
			    <div className="container">
			      ...
			      <div className="primary-nav">
			        ...
			        <a className="main-logo" href="index.html">
			          <img src={require('../../../assets/images/logo/logo-1.png').default.src} alt="" /></a>
			        {/*====== End - Main Logo ======*/}
			        {/*====== Search Form ======*/}
			                        ...
			                        <div className="col-lg-9 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-0.jpg').default.src} alt="" /></a></div>
			                        </div>
			                      </div>
			                      {/*====== End - Mega Menu Row ======*/}
			                    </div>
			                    ...
			                    <div className="mega-menu-content">
			                      ...
			                      <div className="row">
			                        <div className="col-lg-6 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-1.jpg').default.src} alt="" /></a></div>
			                        </div>
			                        <div className="col-lg-6 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-2.jpg').default.src} alt="" /></a></div>
			                        </div>
			                      </div>
			                      {/*====== End - Mega Menu Row ======*/}
			                      <br />
			                      ...
			                      <div className="row">
			                        <div className="col-lg-9 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-3.jpg').default.src} alt="" /></a></div>
			                        </div>
			                        <div className="col-lg-3 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-4.jpg').default.src} alt="" /></a></div>
			                        </div>
			                      </div>
			                      {/*====== End - Mega Menu Row ======*/}
			                    </div>
			                    ...
			                    <div className="mega-menu-content">
			                      ...
			                      <div className="row">
			                        <div className="col-lg-4 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-5.jpg').default.src} alt="" /></a></div>
			                        </div>
			                        <div className="col-lg-4 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-6.jpg').default.src} alt="" /></a></div>
			                        </div>
			                        <div className="col-lg-4 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-7.jpg').default.src} alt="" /></a></div>
			                        </div>
			                      </div>
			                      {/*====== End - Mega Menu Row ======*/}
			                      <br />
			                      ...
			                      <div className="row">
			                        <div className="col-lg-6 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-8.jpg').default.src} alt="" /></a></div>
			                        </div>
			                        <div className="col-lg-6 mega-image">
			                          <div className="mega-banner">
			                            <a className="u-d-block" href="shop-side-version-2.html">
			                              <img className="u-img-fluid u-d-block" src={require('../../../assets/images/banners/banner-mega-9.jpg').default.src} alt="" /></a></div>
			                        </div>
			                      </div>
			                      {/*====== End - Mega Menu Row ======*/}
			                    </div>
			                  ...
			                  <div className="mini-product-container gl-scroll u-s-m-b-15">
			                      ...
			                      <div className="mini-product">
			                        <div className="mini-product__image-wrapper">
			                          <a className="mini-product__link" href="product-detail.html">
			                            <img className="u-img-fluid" src={require('../../../assets/images/product/electronic/product3.jpg').default.src} alt="" /></a></div>
			                    ...
			                    <div className="card-mini-product">
			                      <div className="mini-product">
			                        <div className="mini-product__image-wrapper">
			                          <a className="mini-product__link" href="product-detail.html">
			                            <img className="u-img-fluid" src={require('../../../assets/images/product/electronic/product18.jpg').default.src} alt="" /></a></div>
			                        <div className="mini-product__info-wrapper">
			                          <span className="mini-product__category">
			                            <a href="shop-side-version-2.html">Electronics</a></span>
			                          <span className="mini-product__name">
			                    ...
			                    <div className="card-mini-product">
			                      <div className="mini-product">
			                        <div className="mini-product__image-wrapper">
			                          <a className="mini-product__link" href="product-detail.html">
			                            <img className="u-img-fluid" src={require('../../../assets/images/product/women/product8.jpg').default.src} alt="" /></a></div>
			                        <div className="mini-product__info-wrapper">
			                          <span className="mini-product__category">
			                    ...
			                    <div className="card-mini-product">
			                      <div className="mini-product">
			                        <div className="mini-product__image-wrapper">
			                          <a className="mini-product__link" href="product-detail.html">
			                            <img className="u-img-fluid" src={require('../../../assets/images/product/men/product8.jpg').default.src} alt="" /></a></div>
			                        <div className="mini-product__info-wrapper">
			                          <span className="mini-product__category">
